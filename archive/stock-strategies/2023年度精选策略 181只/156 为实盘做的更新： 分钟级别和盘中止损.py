...
# 原文网址：https://www.joinquant.com/post/36805
# 标题：为实盘做的更新: 分钟级别和盘中止损
# 作者：蚂蚁量化

# 原文网址：https://www.joinquant.com/post/36375
...
def filter_gem_stock(context, stock_list):
    return [stock for stock in stock_list if stock[0:2] != '30' and stock[0:3] != "688"]
